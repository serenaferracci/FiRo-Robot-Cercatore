...
"""autogenerated by genpy from actionlib_example/LaboratorioActionFeedback.msg. Do not edit."""
import sys
...
class LaboratorioActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "actionlib_example/LaboratorioActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','actionlib_example/LaboratorioFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LaboratorioActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = actionlib_example.msg.LaboratorioFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = actionlib_example.msg.LaboratorioFeedback()
