...
"""autogenerated by genpy from navig_robot/navigActionFeedback.msg. Do not edit."""
import sys
...
class navigActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "navig_robot/navigActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','navig_robot/navigFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(navigActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = navig_robot.msg.navigFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = navig_robot.msg.navigFeedback()
