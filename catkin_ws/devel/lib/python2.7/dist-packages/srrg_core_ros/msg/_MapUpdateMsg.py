...
"""autogenerated by genpy from srrg_core_ros/MapUpdateMsg.msg. Do not edit."""
import sys
...
class MapUpdateMsg(genpy.Message):
  _md5sum = "9e0d375602fbc50cf3d9837f15efb92a"
  _type = "srrg_core_ros/MapUpdateMsg"
...
float64 w
"""
  __slots__ = ['seq','updates']
  _slot_types = ['int32','srrg_core_ros/MapNodeUpdateMsg[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MapUpdateMsg, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = srrg_core_ros.msg.MapNodeUpdateMsg()
        start = end
        end += 4
