...
"""autogenerated by genpy from srrg_core_ros/MapNodeMsg.msg. Do not edit."""
import sys
...
class MapNodeMsg(genpy.Message):
  _md5sum = "b4dfc7503338e0289ba1dfed1cad276b"
  _type = "srrg_core_ros/MapNodeMsg"
...
float64 w
"""
  __slots__ = ['id','timestamp','transform','parents']
  _slot_types = ['int32','float64','geometry_msgs/Pose','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,timestamp,transform,parents
    ...
    """
    if args or kwds:
      super(MapNodeMsg, self).__init__(*args, **kwds)
