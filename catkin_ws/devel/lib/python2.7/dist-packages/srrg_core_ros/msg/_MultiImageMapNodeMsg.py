...
"""autogenerated by genpy from srrg_core_ros/MultiImageMapNodeMsg.msg. Do not edit."""
import sys
...
class MultiImageMapNodeMsg(genpy.Message):
  _md5sum = "cd6f139dd1fa5d7aa3e8678fa81bbed5"
  _type = "srrg_core_ros/MultiImageMapNodeMsg"
...
float64 w
"""
  __slots__ = ['id','timestamp','transform','parents','topic','seq','camera_info','subimage_seqs']
  _slot_types = ['int32','float64','geometry_msgs/Pose','int32[]','string','int32','int32','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,timestamp,transform,parents,topic,seq,camera_info,subimage_seqs
    ...
    """
    if args or kwds:
      super(MultiImageMapNodeMsg, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.subimage_seqs)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.pack(pattern, *self.subimage_seqs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.subimage_seqs = struct.unpack(pattern, str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.subimage_seqs.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.subimage_seqs = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
