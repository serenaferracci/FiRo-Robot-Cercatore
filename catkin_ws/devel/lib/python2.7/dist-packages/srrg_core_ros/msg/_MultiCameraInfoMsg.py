...
"""autogenerated by genpy from srrg_core_ros/MultiCameraInfoMsg.msg. Do not edit."""
import sys
...
class MultiCameraInfoMsg(genpy.Message):
  _md5sum = "59f10adeead6803979a53c6477d0fae4"
  _type = "srrg_core_ros/MultiCameraInfoMsg"
...
float64 w
"""
  __slots__ = ['id','offset','topic','frame_id','depth_scale','subcamera_ids']
  _slot_types = ['int32','geometry_msgs/Pose','string','string','float32','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,offset,topic,frame_id,depth_scale,subcamera_ids
    ...
    """
    if args or kwds:
      super(MultiCameraInfoMsg, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      length = len(self.subcamera_ids)
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(struct.pack(pattern, *self.subcamera_ids))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.subcamera_ids = struct.unpack(pattern, str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%si'%length
      buff.write(self.subcamera_ids.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.subcamera_ids = numpy.frombuffer(str[start:end], dtype=numpy.int32, count=length)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
