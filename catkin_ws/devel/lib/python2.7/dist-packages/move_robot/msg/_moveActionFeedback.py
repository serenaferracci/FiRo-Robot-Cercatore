...
"""autogenerated by genpy from move_robot/moveActionFeedback.msg. Do not edit."""
import sys
...
class moveActionFeedback(genpy.Message):
  ...
  _type = "move_robot/moveActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','move_robot/moveFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = move_robot.msg.moveFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = move_robot.msg.moveFeedback()
