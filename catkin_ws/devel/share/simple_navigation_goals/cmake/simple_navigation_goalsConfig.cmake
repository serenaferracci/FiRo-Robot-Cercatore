...
if("TRUE" STREQUAL "TRUE")
  set(simple_navigation_goals_SOURCE_PREFIX /home/serena/catkin_ws/src/simple_navigation_goals)
  set(simple_navigation_goals_DEVEL_PREFIX /home/serena/catkin_ws/devel)
  ...
  set(simple_navigation_goals_INSTALL_PREFIX /home/serena/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'serena <serena@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/serena/catkin_ws/src/simple_navigation_goals/${idir}'.  Ask the maintainer 'serena <serena@todo.todo>' to fix it.")
    endif()
