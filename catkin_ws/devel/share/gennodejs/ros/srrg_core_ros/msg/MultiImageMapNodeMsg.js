...
class MultiImageMapNodeMsg {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('subimage_seqs')) {
        this.subimage_seqs = initObj.subimage_seqs
      }
      else {
        this.subimage_seqs = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [subimage_seqs]
    bufferOffset = _arraySerializer.int32(obj.subimage_seqs, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MultiImageMapNodeMsg(null);
    ...
    // Deserialize message field [subimage_seqs]
    data.subimage_seqs = _arrayDeserializer.int32(buffer, bufferOffset, null)
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 4 * object.subimage_seqs.length;
    return length + 88;
  }

  static datatype() {
    // Returns string type for a message object
    return 'srrg_core_ros/MultiImageMapNodeMsg';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'cd6f139dd1fa5d7aa3e8678fa81bbed5';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MultiImageMapNodeMsg(null);
    if (msg.id !== undefined) {
      resolved.id = msg.id;
    }
    else {
    ...
    if (msg.subimage_seqs !== undefined) {
      resolved.subimage_seqs = msg.subimage_seqs;
    }
    else {
      resolved.subimage_seqs = []
    }
...
module.exports = MultiImageMapNodeMsg;
