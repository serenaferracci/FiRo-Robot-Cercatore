...
(cl:defmethod cl:initialize-instance :after ((m <moveResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'moveResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name move_robot-msg:<moveResult> is deprecated: use move_robot-msg:moveResult instead.")))

(cl:ensure-generic-function 'odom-val :lambda-list '(m))
(cl:defmethod odom-val ((m <moveResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader move_robot-msg:odom-val is deprecated.  Use move_robot-msg:odom instead.")
  (odom m))
